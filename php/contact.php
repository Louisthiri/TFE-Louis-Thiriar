...
// Fields from Realistic contact form. If you need more fields, just add a variable with the "name"
$name     = $_POST['name'];
$email    = $_POST['email'];
...
$address = "victoriamarenghi@gmail.com";
...
$e_body = "vous avez recu un message de la part de  $name: $subject" . PHP_EOL . PHP_EOL;
